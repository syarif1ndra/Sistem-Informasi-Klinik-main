...
class ScreeningController extends Controller
{
    public function create(Patient $patient)
    {
        ...
        return view('bidan.screenings.create', compact('patient', 'icd10Codes'));
    }
    ...
    public function store(Request $request, Patient $patient)
    {
        ...
        return redirect()->route('bidan.patients.show', $patient)
    ...
    public function edit(Patient $patient, Screening $screening)
    {
        ...
        return view('bidan.screenings.edit', compact('patient', 'screening', 'icd10Codes', 'selectedIds'));
    }
