...
class ReportController extends Controller
{
    ...
    public function exportExcel(Request $request)
    {
        ...
        return \Maatwebsite\Excel\Facades\Excel::download(new \App\Exports\BidanReportExport($startDate, $endDate, $paymentMethod, $search), 'laporan-keuangan-bidan-' . $startDate . '-to-' . $endDate . '.xlsx');
    }
