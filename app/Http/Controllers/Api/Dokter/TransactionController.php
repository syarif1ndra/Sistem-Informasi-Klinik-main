...
class TransactionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->successResponse($query->orderByDesc('date')->paginate(15), 'Transaksi dokter');
    }

    /** POST /api/dokter/transactions */
    public function store(Request $request)
    {
        ...
        try {
            ...
            $user       = $request->user();
            $revPct     = $user->revenue_percentage ?? 0;
    ...
    /** GET /api/dokter/transactions/{id} */
    public function show($id)
    {
        $t = Transaction::with(['patient:id,name', 'handledBy:id,name', 'items'])->findOrFail($id);
