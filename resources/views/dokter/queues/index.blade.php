...
@section('content')
    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        <div class="flex items-center gap-4">
            ...
            <form action="{{ route('dokter.queues.index') }}" method="GET" class="flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden border-t-4 border-pink-500">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody id="queue-table-body" class="bg-white divide-y divide-gray-200">
                @include('dokter.queues.partials.table')
            </tbody>
        </table>
    </div>
@endsection
...
@section('scripts')
    <script>
        ...
        const tableDataUrl = '{{ route("dokter.queues.tableDataList") }}';
