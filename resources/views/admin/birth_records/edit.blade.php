                                ...
                                <div class="col-span-2 md:col-span-3">
                                    ...
                                    <div class="grid grid-cols-3 gap-4">
                                        <div class="relative">
                                            ...
                                            <input type="time" name="kala_1" value="{{ $birthRecord->kala_1 }}"
                                                class="w-full rounded-lg border-gray-300 focus:border-pink-500 focus:ring-pink-500 shadow-sm transition p-2.5">
                                        </div>
                                        <div class="relative">
                                            <label class="text-xs text-gray-500 mb-1 block">Kala II (Jam)</label>
                                            <input type="time" name="kala_2" value="{{ $birthRecord->kala_2 }}"
                                                class="w-full rounded-lg border-gray-300 focus:border-pink-500 focus:ring-pink-500 shadow-sm transition p-2.5">
                                        </div>
                                        <div class="relative">
                                            <label class="text-xs text-gray-500 mb-1 block">Kala III (Jam)</label>
                                            <input type="time" name="kala_3" value="{{ $birthRecord->kala_3 }}"
                                                class="w-full rounded-lg border-gray-300 focus:border-pink-500 focus:ring-pink-500 shadow-sm transition p-2.5">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="attendant_name" value="{{ $birthRecord->attendant_name }}"
                                        class="w-full rounded-lg border-gray-300 focus:border-pink-500 focus:ring-pink-500 shadow-sm transition p-2.5"
