<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="space-x-2">
                <a href="{{ route('admin.birth_records.edit', $birthRecord) }}"
                    class="bg-yellow-600 text-white px-4 py-2 rounded-lg hover:bg-yellow-700">
                    Edit
                </a>
                <a href="{{ route('admin.birth_records.generatePdf', $birthRecord) }}"
                    class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700" target="_blank">
                    Cetak PDF
                </a>
            </div>
        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900">
                                    <span
                                        class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full {{ $birthRecord->gender === 'L' ? 'bg-blue-100 text-blue-800' : 'bg-pink-100 text-pink-800' }}">
                            ...
                            <div>
                                <span class="text-sm font-medium text-gray-600">Jam Kala I:</span>
                                <p class="text-gray-900">{{ $birthRecord->kala_1 ?? '-' }}</p>
                            </div>
                            <div>
                                <span class="text-sm font-medium text-gray-600">Jam Kala II:</span>
                                <p class="text-gray-900">{{ $birthRecord->kala_2 ?? '-' }}</p>
                            </div>
                            <div>
                                <span class="text-sm font-medium text-gray-600">Jam Kala III:</span>
                                <p class="text-gray-900">{{ $birthRecord->kala_3 ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
