        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div class="bg-gradient-to-r from-pink-500 to-rose-600 px-8 py-6">
                    <h2 class="text-2xl font-bold text-white">Lengkapi Data Pasien</h2>
                    <p class="text-pink-100 mt-2">Mohon lengkapi data diri Anda sebelum melakukan pendaftaran.</p>
                </div>

                <form action="{{ route('user.patient.store') }}" method="POST" class="p-8 space-y-6">
                    @csrf
