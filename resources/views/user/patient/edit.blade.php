            ...
            <div class="bg-white rounded-[2rem] shadow-2xl shadow-gray-200/50 overflow-hidden border border-gray-100">
                <div class="bg-gradient-to-br from-pink-500 via-rose-500 to-rose-600 px-8 py-10 relative">
                    ...
                    <div class="relative flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            ...
                            <p class="text-pink-100 mt-1 font-medium italic opacity-90">Perbarui informasi profil kesehatan
                                Anda.</p>
                        </div>
                ...
                <form action="{{ route('user.patient.update') }}" method="POST" class="p-8 md:p-10 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div class="space-y-2">
                            <label for="nik" class="block text-sm font-bold text-gray-700 ml-1">NIK (Nomor Induk
                                Kependudukan)</label>
                            <input type="text" name="nik" id="nik" value="{{ old('nik', $patient->nik) }}"
                                ...
                                minlength="16" maxlength="16" pattern="\d{16}" title="NIK harus terdiri dari 16 angka"
                                required>
                        ...
                        <div class="space-y-2">
                            <label for="phone" class="block text-sm font-bold text-gray-700 ml-1">Nomor HP /
                                WhatsApp</label>
