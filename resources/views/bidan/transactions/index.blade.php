...
@section('content')
    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        <form action="{{ route('bidan.transactions.index') }}" method="GET" class="flex items-center">
    ...
    <div class="mb-4">
        <a href="{{ route('bidan.transactions.create') }}"
                ...
                @forelse($transactions as $transaction)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('bidan.transactions.show', $transaction) }}"
                                class="text-pink-600 hover:text-pink-900 mr-2">Detail</a>
                            <a href="{{ route('bidan.transactions.edit', $transaction) }}"
