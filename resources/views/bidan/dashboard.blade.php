...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <!-- Kehamilan -->
        <div class="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 border border-gray-50">
            <h3 class="text-md font-bold text-gray-800 mb-6 flex items-center gap-2">
                <span class="w-2 h-2 rounded-full bg-rose-500"></span> Pemeriksaan Kehamilan (12 Bln)
            </h3>
        ...
        <div class="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 border border-gray-50">
            <h3 class="text-md font-bold text-gray-800 mb-6 flex items-center gap-2">
                <span class="w-2 h-2 rounded-full bg-blue-500"></span> Imunisasi Bayi (12 Bln)
            </h3>
        ...
        <div class="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 border border-gray-50">
            <h3 class="text-md font-bold text-gray-800 mb-6 flex items-center gap-2">
                <span class="w-2 h-2 rounded-full bg-emerald-500"></span> Persalinan (12 Bln)
            </h3>
    ...
    <div class="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-50">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-100">
                ...
                <tbody id="bidan-queue-table-body" class="bg-white divide-y divide-gray-50">
